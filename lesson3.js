...
//Взяла из криптографии метод шифрования пар (без матриц и прочих усложнений, на хабре нашла) - здесь нахожу соответствие по символам в keys1, и затем по индексу приравниваю к keys2. 
//Дешифратор такой же, просто цифры меняются местами. 
